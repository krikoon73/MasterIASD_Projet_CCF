...
if [ $retVal -ne 0 ]; then
	...
	# Generate CSV
	echo $JOB_NAME,$PYTHON_SCRIPT,$NUM_EXECUTOR_CORES,$NUM_EXECUTORS,$EXECUTOR_MEMORY,$EXECUTOR_MEMORY_OVERHEAD,$NUM_DRIVER_CORES,$DRIVER_MEMORY,$PROCESS_TIME,$ITERATION > $LOGDIR/$CSV_LOG_NAME
fi
